...
class Database
{
     ...
     * @param  integer $port
     */
    public static function config($bd = 'mysql', $host, $name, $user, $pass, $port = 3306)
    {
        self::$bd   = $bd;
        self::$host = $host;
        self::$name = $name;
    ...
    {
        try {          
            $this->connection = new PDO(self::$bd.':host=' . self::$host . ';dbname=' . self::$name . ';port=' . self::$port, self::$user, self::$pass);
